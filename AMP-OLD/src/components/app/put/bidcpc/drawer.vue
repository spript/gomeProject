		...
		<transition name="drawer">
			<div class="amp-drawer" v-if="config.show">
				...
				<div class="drawer-btn">
					...
					<button class="btn btn-primary" v-show="config.type !== 'idea' && config.type !== 'idea_url' && config.action === 'new'" @click="saveAndNext()">保存并下一步</button>
...
export default {
	...
	data() {
		return {
			...
			orderKey: ['plan', 'unit', 'idea', 'idea_url'],
			orderMsg: ['投放计划', '投放单元', '创意', '创意'],
			actionMap: {
				new: '新建',
				copy: '复制',
				modify: '修改'
