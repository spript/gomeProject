            ...
            <tbody>
              <template v-for="item in list">
                <tr :class="{actived: item.isActived, 'body-row': true}">
                  <td rowspan="2"><span><em @click="checkbox(item.flightId)" :class="'icon icon-select select-' + item.flightId" :data-id="item.flightId"></em><i class="data-id">{{item.flightId}}</i></span></td>
                  <td rowspan="2">
                    <span>
                      <i class="ellipsis">
                  ...
                  <td><span>搜索</span></td>
                  <td><span>{{item.dmpData[0].search.searchMinBid}}~{{item.dmpData[0].search.searchMaxBid}}</span></td>
                  <td><span>{{item.dmpData[0].search.impressionNumber == null ? "--" : item.dmpData[0].search.impressionNumber}}</span></td>
                  <td><span>{{item.dmpData[0].search.clickNumber == null ? "--" : item.dmpData[0].search.clickNumber}}</span></td>
                  <td><span>{{item.dmpData[0].search.clkRate == null ? "--" : item.dmpData[0].search.clkRate}}</span></td>
                  <td><span>{{item.dmpData[0].search.totalFee == null ? "--" : item.dmpData[0].search.totalFee}}</span></td>
                  <td><span>{{item.dmpData[0].search.clickUnitPrice == null ? "--" : item.dmpData[0].search.clickUnitPrice}}</span></td>
                  <td><span>{{item.dmpData[0].search.costPerMills == null ? "--" : item.dmpData[0].search.costPerMills}}</span></td>
                  <td rowspan="2"><span>
                    <b class="operat-link">
                ...
                <tr>
                  <td><span>推荐</span></td>
                  <td><span>{{item.dmpData[0].recomment.adBid == null ? "--" : item.dmpData[0].recomment.adBid}}</span></td>
                  <td><span>{{item.dmpData[0].recomment.impressionNumber == null ? "--" : item.dmpData[0].recomment.impressionNumber}}</span></td>
                  <td><span>{{item.dmpData[0].recomment.clickNumber == null ? "--" : item.dmpData[0].recomment.clickNumber}}</span></td>
                  <td><span>{{item.dmpData[0].recomment.clkRate == null ? "--" : item.dmpData[0].recomment.clkRate}}</span></td>
                  <td><span>{{item.dmpData[0].recomment.totalFee == null ? "--" : item.dmpData[0].recomment.totalFee}}</span></td>
                  <td><span>{{item.dmpData[0].recomment.clickUnitPrice == null ? "--" : item.dmpData[0].recomment.clickUnitPrice}}</span></td>
                  <td><span>{{item.dmpData[0].recomment.costPerMills == null ? "--" : item.dmpData[0].recomment.costPerMills}}</span></td>
                </tr>
              </template>
            </tbody>
          </table>
