				...
				<el-form :model="formData" :rules="rules" ref="formData" label-width="140px">
					<div>
						...
						<el-form-item label="投放单元名称：" prop="name">
							<el-input v-model="formData.name" style="width:420px"></el-input>
						</el-form-item>
					...
					<div>
						...
						<el-form-item v-show="researchype" prop="validQuestionnaireNum" :class="{rebateContent:true,questionRebate:true,rebateDisabled:!researchRebate}">
							...
							<el-col :span="3" prop="validQuestionnaireNum">
								<el-input  v-model.number="formData.validQuestionnaireNum" style="widht: 100%" :disabled="formData.questionnaireTotalLimited == 0 "></el-input>
							</el-col>
							<el-col :span="2">
