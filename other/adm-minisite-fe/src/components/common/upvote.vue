<template>
	<div class="upvote" :class="cPraiseStatus == '1' ? 'parised' : 'normal' " @click="upvote">
		<img v-if="cPraiseStatus == '0'" src="../../assets/images/icon_like_2x_normal.png"/><img v-else src="../../assets/images/icon_like_2x_press.png"/><span>{{cPariseNumber | formatCount}}</span>
	</div>
</template>
