		...
		<transition name="drawer">
			<div class="amp-drawer" v-if="showRefuse" >
				<div class="drawer-part">
					...
					<div class="shop-cont">
						...
						<el-checkbox-group v-model="checkList">
							<el-checkbox label="问卷内容不符合要求"></el-checkbox>
							<br>
				...
				<div class="drawer-btn">
					<span class="btn btn-primary" @click="surveyRefuseAction">确定</span>
...
export default {
	name: 'app-survey-refuse',
	props: ['showRefuse','surveyId'],
	data() {
		return {
	        checkList: [],
	        textarea: '',
